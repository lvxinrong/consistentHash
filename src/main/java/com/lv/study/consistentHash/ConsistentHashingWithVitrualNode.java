package com.lv.study.consistentHash;
 ...
 *
 */
public class ConsistentHashingWithVitrualNode {
    ...
    static {  
        ...
        for (String str : realNodes) {  
            for (int i = 0; i < VIRTUAL_NODES; i++) {
            	//虚拟节点和实际节点的对应，在这里是通过对name的字符串的拼接，然后取hash值，
            	//通过虚拟节点关联实际节点的时候，通过字符串的截取，就可以去到真实节点的name，然后通过key去取真实节点就好
